namespace TradeAndTravel
{
    ...
    {
        public AdvanceInteractionManager() : base()
        {
        }
        ...
        private void CraftWeapon(Person actor, string craftedItemName)
        {
            ...
            if (actorInvetory.Any((item) => item.ItemType == ItemType.Iron) &&
                actorInvetory.Any((item) => item.ItemType == ItemType.Wood))
            {
        ...
        private void HandleGatherInteraction(Person actor, string gatheredItemName)
        {
            ...
            {
                var actorInventary = actor.ListInventory();

                foreach (var item in actorInventary)
                {
